...
export RESTIC_REPOSITORY="sftp:saywer:/pale/backups/archive"   # *EDIT* fill with your repo name
...
export RESTIC_BACKUP_PATHS="/mass/backup/archive"  # *EDIT* fill conveniently with one or multiple paths
