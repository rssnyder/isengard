...
export RESTIC_REPOSITORY="sftp:saywer:/pale/backups/syndicated"   # *EDIT* fill with your repo name
...
export RESTIC_BACKUP_PATHS="/mass/media/syndicated"  # *EDIT* fill conveniently with one or multiple paths
