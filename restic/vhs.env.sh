...
export RESTIC_REPOSITORY="sftp:saywer:/pale/backups/vhs"   # *EDIT* fill with your repo name
...
export RESTIC_BACKUP_PATHS="/mass/media/vhs"  # *EDIT* fill conveniently with one or multiple paths
