...
export RESTIC_REPOSITORY="sftp:saywer:/pale/backups/immich"   # *EDIT* fill with your repo name
...
export RESTIC_BACKUP_PATHS="/mass/immich"  # *EDIT* fill conveniently with one or multiple paths
