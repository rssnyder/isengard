...
export RESTIC_REPOSITORY="sftp:saywer:/pale/backups/zira"   # *EDIT* fill with your repo name
...
export RESTIC_BACKUP_PATHS="/home/riley"  # *EDIT* fill conveniently with one or multiple paths
