...
# services: only devices explicitly pinned here via unifi_user.network_id
# below get an address on this network -- see infra/network.tf for the
# Clients/IoT split this is part of.
